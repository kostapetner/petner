...
<div class="btnSet">
<button type="submit" onclick="if( necessary() ){ $('form').submit() }">저장</button>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/file_attach.js"></script>
