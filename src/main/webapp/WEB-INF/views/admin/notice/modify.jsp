...
<c:if test="${not empty authUser}">
	...
	<c:if test="${authUser.user_type >= 9}">
		...
		<div class="card ad_card mb-4">
			<div class="card-body">
				<h2 class="card-title">공지사항 글 수정</h2>
				<div class="formbox">
					<form action="ad_update_notice" method="post"
						...
						<div class="pn_view">
							...
							<div class="btnSet">
								...
								<a class="btn-empty btn btn-outline-secondary" href="ad_detail_notice?id=${vo.id }">취소</a>
							</div>
						</div>
					</form>
				</div>
