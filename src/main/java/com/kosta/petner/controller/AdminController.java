...
//			ModelAndView mav = new ModelAndView();
		...
		// 글쓰기 화면 이동
		@RequestMapping(value = "/ad_writeform", method = RequestMethod.GET)
		public String ad_writeform(Model model) {
...
//			model.addAttribute("title", "공지사항 글쓰기");
		...
		@RequestMapping(value = "/ad_modifyform", method = RequestMethod.GET)
		String ad_modifyform(@RequestParam("notice_no") Integer noticeNum, Model model) {
			// ModelAndView mav = new ModelAndView();
			try {
				Notice notice = noticeService.getNotice(noticeNum);
				model.addAttribute("article", notice);
		...
		@RequestMapping(value = "/ad_replyform", method = RequestMethod.GET)
		public String ad_replyform(@RequestParam("notice_no") Integer noticeNum,
				@RequestParam(value = "page", required = false, defaultValue = "1") Integer page, Model model) {
			// ModelAndView mav = new ModelAndView();
...
//				model.addAttribute("/layout/admin_main");
		...
		@RequestMapping(value = "/ad_deleteform", method = RequestMethod.GET)
		public ModelAndView ad_deleteform(@RequestParam("notice_no") Integer noticeNum,
